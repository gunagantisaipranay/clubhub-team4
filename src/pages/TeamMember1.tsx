      ...
      <main className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <h2 className="rainbow-text text-3xl md:text-4xl font-semmibold text-foreground mb-2">
              {student.fullName}
            </h2>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-bold">{student.gender}</p>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-muted-foregroung mb-1">marks</p> 
                    <p className="rainbow-text text-3xl md:text-4xl font-bold text-foreground mb-1">{student.marks}</p>
                  </div>
